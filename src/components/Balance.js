	...
	return (
		<div className='component exchange__transfers'>
			<div className='component__header flex-between'>
				<h2>Balance</h2>
				<div className='tabs'>
					<button onClick={tabHandler} ref={depositRef} className='tab tab--active'>
						Deposit
					</button>
			...
			<div className='exchange__transfers--form'>
				<div className='flex-between'>
					<p>
						{' '}
						<small>Token</small> <br /> <img src={eth} alt='' /> {symbols && symbols[0]}{' '}
					</p>
					<p>
						{' '}
						<small>Wallet</small> <br /> {tokenBalances && tokenBalances[0]}{' '}
					</p>
					<p>
						{' '}
						<small>Exchange</small> <br /> {exchangeBalances && exchangeBalances[0]}{' '}
					</p>
				</div>
			...
			<div className='exchange__transfers--form'>
				<div className='flex-between'>
					<p>
						{' '}
						<small>Token</small> <br /> <img src={eth} alt='' /> {symbols && symbols[1]}
					</p>
					<p>
						{' '}
						<small>Wallet</small> <br /> {tokenBalances && tokenBalances[1]}
					</p>
					<p>
						<small>Exchange</small> <br /> {exchangeBalances && exchangeBalances[1]}
					</p>
				</div>
